...
gg_leg <- gtable::gtable_filter(ggplot_gtable(ggplot_build(
  ggplot(ggpoly, aes(x = long, y = lat, color = id)) +
    ...
    theme(legend.direction = "horizontal", legend.title = element_text(size = 12), legend.text = element_text(size = 10), legend.key.width = unit(1, "lines"), legend.justification = "left")
)), "guide-box")
